                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div className="relative mb-4">
                            ...
                            <input
                                ...
                                required
                                value={formData.name}
                                className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-white transition focus:outline-none focus:border-pink-300 focus:bg-pink-300/5"
                                placeholder="Name.. "
